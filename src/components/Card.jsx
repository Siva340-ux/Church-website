...
export default function WhyNeeded() {
    ...
    return (
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '60px 20px', fontFamily: 'sans-serif' }}>
            ...
            <Card title="The Painful Condition of Human Life" items={painfulConditions} />
            <Card title="Sins of the Heart (Inner Character)" items={sinsOfTheHeart} />
            <Card title="Sins of the Heart (Inner Character)" items={categories} />
            <Card title="Sins of Speech" items={sinsOfSpeech} />
            <Card title="Sins of Conduct" items={cat1} />
            <Card title="SEXUAL SINS AND EXPLOITATION" items={cat2} />
            <Card title="VIOLENCE AGAINST HUMAN LIFE" items={cat3} />
            <Card title="FAMILY PROBLEMS" items={cat4} />
            <Card title="SOCIAL EVILS" items={cat5} />
            <Card title="CRIME AND LAWLESSNESS" items={cat6} />
            <Card title="ADDICTIONS AND DESTRUCTIVE HABITS" items={cat7} />
            <Card title="MORAL AND SPIRITUAL DECLINE" items={cat8} />
            <Card title="GOVERNMENTAL AND NATIONAL EVILS" items={cat9} />
            <Card title="ENVIRONMENTAL DESTRUCTION" items={cat10} />
            <Card title="TECHNOLOGICAL AND DIGITAL EVILS" items={cat11} />
            <Card title="GLOBAL HUMAN SUFFERING" items={cat12} />
        </div>
    );
}