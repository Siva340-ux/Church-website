...
const ProducerAlbum = () => {
    ...
    return (
        <div className="producer-album-page" style={{ backgroundColor: '#ffffff', color: '#000000', minHeight: '100vh', width: '100%', maxWidth: '100%', overflowX: 'hidden', fontFamily: 'sans-serif', boxSizing: 'border-box' }}>
            ...
            {/* Main Body Content */}
            <div style={{ maxWidth: '1300px', margin: '0 auto', padding: '50px 20px', textAlign: 'center' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', borderRadius: '16px', padding: '35px', textAlign: 'left', gap: '30px', width: "100%" }}>
                    <div style={{ width: '240px', height: '320px', flexShrink: 0, backgroundColor: '#bfdbfe', borderRadius: '12px', overflow: 'hidden', border: '1px solid #d1d5db', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <img
                            src={founder}
                            alt="founder"
                    ...
                    <div style={{ flexGrow: 1 }}>
                        ...
                        <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '13px', color: '#1f2937' }}>
                            <li style={{ display: 'flex', alignItems: 'flex-start' }}><span style={{ color: '#ca8a04', fontWeight: 'bold', marginRight: '8px' }}>✓</span> Featured 14 renowned singers delivering soul-stirring performances</li>
                            <li style={{ display: 'flex', alignItems: 'flex-start' }}><span style={{ color: '#ca8a04', fontWeight: 'bold', marginRight: '8px' }}>✓</span> Composed, arranged, and written by M. John Peter with world-class quality</li>
                            <li style={{ display: 'flex', alignItems: 'flex-start' }}><span style={{ color: '#ca8a04', fontWeight: 'bold', marginRight: '8px' }}>✓</span> Contains 745 meticulously crafted music tracks across 10 thematic songs</li>
                            <li style={{ display: 'flex', alignItems: 'flex-start' }}><span style={{ color: '#ca8a04', fontWeight: 'bold', marginRight: '8px' }}>✓</span> Built on a strong theological message centered on the Sabbath truth</li>
                            <li style={{ display: 'flex', alignItems: 'flex-start' }}><span style={{ color: '#ca8a04', fontWeight: 'bold', marginRight: '8px' }}>✓</span> Designed to inspire listeners to revisit and rediscover the Word of God</li>
                            <li style={{ display: 'flex', alignItems: 'flex-start' }}><span style={{ color: '#ca8a04', fontWeight: 'bold', marginRight: '8px' }}>✓</span> Blends classical, contemporary, and spiritual music elements</li>
                        </ul>
                    </div>
                </div>
