...
const AcknowledgementCard = ({ title, items, description }) => {
    return (
        <div style={{
            ...
            <h3 style={{ fontSize: '18px', fontFamily: 'serif', fontWeight: '900', color: '#b45309', letterSpacing: '0.5px', textTransform: 'uppercase', marginBottom: '20px' }}>
                {title}
            </h3>
    ...
    return (
        <div className="min-h-screen bg-black text-white p-8">
            ...
            <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '60px 20px', fontFamily: 'sans-serif', textAlign: 'center' }}>
                {/* Heading */}
                <h2 style={{ fontSize: '26px', fontFamily: 'serif', fontWeight: '900', color: '#b45309', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '20px' }}>
                    Our Gratitude
                </h2>
